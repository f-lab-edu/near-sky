...
public class JsonUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String DEFAULT_LOGIN_REQUEST_URL = "/api/v1/login";  // /login/oauth2/ + ????? 로 오는 요청을 처리
    private static final String HTTP_METHOD = "POST";    //HTTP 메서드의 방식
